...
- Database: MySQL
## Demo Link :https://35.88.163.20/asm01/
...
- Step 6: Access the application via web browser at `http://localhost:8080` (where `port` is the port on which the web server is running).
